public class Homework_14{
    public static void main(String[] args){
        ...
        System.out.println("จำนวนพัสดุทั้งหมด = " + codesAll + " ชิ้น");
        //แสดงจำนวนพ้สดุที่มาจากไทย
        System.out.println("จำนวนพัสดุทั้งหมด = " + codesThai + " ชิ้น");
        //แสดงจำนวนพัสดุที่มาจากต่างประเทศ
        System.out.println("จำนวนพัสดุที่มาจากต่างประเทศ = " + codesEn + " ชิ้น");
        System.out.println("=======================================================");
    } 
